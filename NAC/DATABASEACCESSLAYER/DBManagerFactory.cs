/*Designed and Developed by Momentum India Pvt. Ltd.

 Description		:   The class manages different data provider.a) SQL Server b)ODBC 
						c) OLEDB d)Oracle.  
...
namespace DataAccessLayer
{
	public sealed class DBManagerFactory
	{
		...
		public static IDbTransaction GetTransaction(DataProvider providerType , IsolationLevel isolationLevel)
		{
			IDbConnection iDbConnection =GetConnection(providerType);

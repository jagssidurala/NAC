...
namespace BusinessLayer
{
    ///<remarks>
    ///===================================================================
    /// Name: File Name				: BLCandidateSearchByAdmin.cs
    /// Construction Date			: 
    /// Author: Developer's Name	: Manoj Kuamr Sijwali
    /// Description					: Candidates can be searched on basis of registration id,
    ...
    ///</remarks> 
    ///
    public class BLCandidateSearchByAdmin
    {
        public BLCandidateSearchByAdmin()
        {
            //
        ...
        public DataSet SearchCandidate()
        {
            try
            {
                ...
                int counter = 0;
                dbManager.AddParameters(counter++, "@UserId", UserID );
                ...
                return ((DataSet)dbManager.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "SearchCandidateByAdmin"));
        ...
        public DataTable ExportAllCandidateListByAdmin()
        {
            try
            {
                ...
                return ((DataTable)dbManager.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "ExportAllCandidateListByAdminV2").Tables[0]);
        ...
        #region GenerateAllMultipleAdmitCardAdminV2()

        public DataSet GenerateAllMultipleAdmitCardAdminV2()
        {
            try
            {
                conn = new DBConnection();
                ...
                //return ((DataSet) dbManager.ExecuteDataSet(System.Data.CommandType.StoredProcedure,"GeAllMultipleAdmitCardAdminV2"));		
                return ((DataSet)dbManager.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "GetAllAdmitCardsByAdminV2"));
        ...
        #region GenerateAllCandidateDetailsAdminV2()

        public DataSet GenerateAllCandidateDetailsAdminV2()
        {
            try
            {
                conn = new DBConnection();
                ...
                int counter = 0;
                dbManager.AddParameters(counter++, "@strRegistration", RegistrationID);
                dbManager.AddParameters(counter++, "@TestDateFrom", TestDateFrom);
                dbManager.AddParameters(counter++, "@TestDateTo", TestDateTo);
                ...
                return ((DataSet)dbManager.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "GetAllCandidateDetails"));

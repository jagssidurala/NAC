<%@ Page language="c#" Codebehind="CandidatesExportToExcelByCompany.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.NACdb.CandidatesExportToExcelByCompany" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE style="POSITION: absolute; TOP: 0px; LEFT: 0px" border="1" cellSpacing="0" cellPadding="0">
				...
				<tr vAlign="top">
					<td vAlign="top" colSpan="51"><asp:datagrid id="dgCandidateList" runat="server" AutoGenerateColumns="False" CssClass="ExlsTableDataGridBody"
							...
							<Columns>
								<asp:BoundColumn DataField="rowid" HeaderText="rowid" HeaderStyle-Height="15px"></asp:BoundColumn>

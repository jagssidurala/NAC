<%@ Page language="c#" Codebehind="Arunachal_Pradesh.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.Arunachal_Pradesh" %>
														...
														<td>
															<table id="tblHeader1" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr vAlign="top" align="left">
																	...
																	<td align="right" background="images/header_bg.gif">&nbsp;<IMG id="imgStateLogo" height="85" src="images/Arunachal.gif" runat="server">
																	</td>
																</tr>
															</table>
														</td>
																...
																<TBODY>
																	<TR>
																		<TD class="grey_bg main_black" vAlign="middle" align="left" height="30"><strong>Government 
																				of Arunachal Pradesh launches NAC</strong></TD>
																	</TR>
																	<TR>
																		<TD class="white_bg main_black" vAlign="top" align="left">
																			<p align="justify">Government of Arunachal Pradesh and NASSCOM (National 
																				Association of Software and Service Companies) jointly introduce<SPAN class="big_maroon">
																					NASSCOM Assessment of Competence (NAC)</SPAN> - an 
																				assessment-cum-certification program for candidates who aspire to be a part of 
																				the ITES-BPO industry. Government of Arunachal Pradesh, in association with 
																				NASSCOM, is the implementing body for the NAC Assessment. NASSCOM, with active 
																				participation of ITES-BPO industry players, designed NAC, which is aimed at 
																				creating a robust and continuous pipeline of talent by transforming the 
																				"trainable" workforce into an "employable" workforce. As working with the 
																				ITES-BPO industry involves working primarily for global clients, that too in a 
																				global environment, the preferred language (medium of instruction) is English.
																			</p>
																			<p><strong> NAC is to become a national-level certification program and its very first 
																					administration at Arunachal Pradesh successfully took place in the month of 
																					December 07. This was open to all undergraduate and postgraduate students of 
																					any stream who wish to be employed with the IT companies in future. </strong>
																			</p>
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Govt. 
																										of Arunachal Pradesh announces the JOB FAIR for NAC candidates</strong></font> &nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><strong><br>
																								<span style="FONT-WEIGHT: bold; FONT-SIZE: 11px; FONT-FAMILY: Verdana">The first round of Arunachal Pradesh NAC successfully took place on 02 
																								December 2007 at Itanagar, Doimukh and Nirjuli where approx. 150 candidates 
																								took the test. The <u>score cards</u> and <u>job fair 
																										cards</u> for first round candidates are now available on the website.</span>
																							</strong>
																							<hr>
																							<div align="center" style="COLOR: #cc0000"><strong>ARUNACHAL PRADESH NAC JOB FAIR </strong>
																								<br>
																								...
																								<tr>
																									...
																									<td style="FONT-SIZE: 11px; COLOR: #000099" align="left">
																										<ol>
																											...
																											<li>
																												<span><strong><a href="http://www.nac.nasscom.in/Time allocation chart (Arunachal).xls" target="_blank">
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Score 
																										cards for Arunachal Pradesh NAC are now available on this website </strong></font>
																								&nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99">
																							...
																							</strong><span lang="EN-US" style="FONT-SIZE:10pt;
																							COLOR:#333399;
																							FONT-FAMILY:'Times New Roman';
																							mso-bidi-font-size:9.0pt;
																							mso-fareast-font-family:'Times New Roman';
																							mso-ansi-language:EN-US;
																							mso-fareast-language:EN-US;
																							mso-bidi-language:AR-SA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><I>Ideally the print 
																										out of your Score Card should come in 2 pages. Hence, go to 'File &gt; Page 
																										Setup' and ensure the
																										<br>
																				...
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="blue_bg" vAlign="middle" height="25"><span class="main_white_bold"><span class="mainwhitebold1">First 
																									round of Arunachal Pradesh NAC</span></span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							<strong>The first round of Arunachal Pradesh NAC successfully took place on 02 
																								December 2007 at Itanagar, Doimukh and Nirjuli where approx. 150 candidates 
																								took the test. </strong>
																							<br>
																							<br>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							<ol>
																								...
																								<li>
																									North-East Regional Institute of Science & Technology (NERIST), Nirjuli
																								</li>
																							</ol>
																						</TD>
																					</TR>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						...
																						<br>
																							<ol>
																								<li>
																									Mr. Chau Dhanya Mungyak, Scientist-'B'<br>
																									Department of IT and Science & Technology<br>
																									Government of Arunachal Pradesh<br>
																									Phone : 0360-2290833 (O)<br>
																									Tele-fax: 0360-2212934 (O)<br>
																									Mobile : 09436227753
																									<br>
																									<br>
																								</li>

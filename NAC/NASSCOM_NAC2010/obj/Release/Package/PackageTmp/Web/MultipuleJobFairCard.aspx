...
<%@ Page language="c#" Codebehind="MultipuleJobFairCard.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.MultipuleJobFairCard" %>
	...
	<body>
		<form id="form1" runat="server">
											...
											<tr>
												<td class="white_bg" vAlign="top" align="left">
													<table cellSpacing="0" cellPadding="1" width="100%" border="0">
														<TR class="white_bg" vAlign="top">
															<TD class="grey_bg main_black">
																<CENTER>
																	<H4>
																		<%# DataBinder.Eval(Container.DataItem, "State") %>  NAC<BR>
																		...
																		<TD vAlign="top" align="left" width="76%">
																			...
																			<TABLE class="blue_bg" cellSpacing="0" cellPadding="5" width="100%" border="1">
																				...
																				<tr class="white_bg" vAlign="middle" align="left">
																					...
																					<td width="40%">
																						<%# DataBinder.Eval(Container.DataItem, "Listening") %>
																					</td>
																				</tr>
																				<tr class="white_bg" vAlign="middle" align="left">
																					<TD width="20%" class="white_bg">Writing:</TD>
																					<td width="40%">
																				...
																				<tr class="white_bg" vAlign="middle" align="left">
																					...
																					<td width="40%">
																						<%# DataBinder.Eval(Container.DataItem, "Speaking") %>
																					</td>
																				</tr>
																			</TABLE>
																		</TD>
			...
			<asp:Panel ID="pnlMessage" Runat="server">
				<TR class="white_bg">
					<TD align="center" vAlign="top" background="images/tbg_left.gif" width="7"></TD>
					<TD align="center" vAlign="bottom">
						<uc1:nac_header id="Nac_header1" runat="server"></uc1:nac_header></TD>
					<TD align="center" vAlign="top" background="images/tbg_right.gif" width="7"></TD>
				</TR>
				<TR>
					<TD align="right" vAlign="top" background="images/tbg_left.gif" width="7"><IMG height="1" src="images/spacer.gif" width="7"></TD>
							...
							<TR vAlign="middle">
								<TD align="center">
									<DIV id="NoPrint" align="center">
										<asp:Label id="lblMessage" Runat="server" Text="There is no job fair card details found" ForeColor="Red"
					...
					<TD align="center" vAlign="top" background="images/tbg_right.gif" width="7" height="100%"><IMG height="1" src="images/spacer.gif" width="7">
					</TD>
				</TR>
				<TR class="white_bg">
					<TD align="center" vAlign="top" background="images/tbg_left.gif" width="7"></TD>

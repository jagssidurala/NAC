...
<%@ Page language="c#" Codebehind="TestScorePercentage.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.TestScorePercentage" %>
						...
						<TABLE id="SecondPage" borderColor="#000000" height="600" cellSpacing="0" cellPadding="35"
							...
							<tr>
								<td align="center">
									...
									<INPUT id="NoPrintBottom" onclick="PrintReport();" type="button" value="Print" name="NoPrint" class=button>&nbsp;
									<asp:Button id="btnSaveBottom" runat="server" Text="Save" CssClass="button" onclick="btnSave_Click"></asp:Button>&nbsp;
									<asp:Button id="btnBackBottom" runat="server" Text="Back" CssClass="button" onclick="btnBack_Click"></asp:Button></td>
							</tr>
						</TABLE>
					</td>
				</tr>

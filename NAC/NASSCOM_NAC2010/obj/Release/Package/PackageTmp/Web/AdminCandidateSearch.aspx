<%@ Page language="c#" Codebehind="AdminCandidateSearch.aspx.cs" AutoEventWireup="True"  EnableEventValidation="false" Inherits="NASSCOM_NAC.Web.AdminCandidateSearch" %>
...
//			var varForm = document.frmSearch;
			var varForm = document.getElementById("frmSearch");
		...
		function SelectSingleCandidate()
	  {
		...
		//alert(document.getElementById("hdSelectedCandidateCount").value);
	      ...
	      {
			  varSelectedCandidateCount = 0;
			  varSelectedCandidateCount2 = 0;
	          alert("Please select candidate from candidate list");
	          return false;
	      }
		}
		...
		//alert(document.getElementById("hdSelectedCandidateCount").value);
	      ...
	      if(varSelectedCandidateCount > 0 || varSelectedCandidateCount2 >0)
	      {
	         return confirm('Are you sure you want to disable selected candidate(s)?');
	      }
	      else
	      {
	          alert("Please select candidate from candidate list");
		...
		function CheckAllCandidate()
		{
		   ...
		   if(chkVar)
		   {
		       var varForm = document.getElementById("frmSearch"); // document.frmSearch;
...
function validateNum(evt) {
    ...
    if (!regex.test(key)) {
		...
		(document.getElementById("ddlDOBdayTo").value != "0" && document.getElementById("ddlDOBmonthTo").value != "0" && document.getElementById("ddlDOByearTo").value != "0"))
            ...
            varUserId = document.getElementById("txtUsrtId").value;
			...
			*/
			...
			if (varUserId == "" && varRegistrationID == "" && varTestDateFrom == "" && varTestDateTo == "" && varDOBDateFrom == "" && varDOBDateTo == "" && 
		...
		<FORM id="frmSearch" method="post" runat="server">
			...
			<DIV align="center">
				<table id="table1" border="0" cellSpacing="0" cellPadding="0">
					<tr>
						<td>
							<table id="Table_01" border="0" cellSpacing="0" cellPadding="0" width="888">
																...
																<fieldset align="left"><legend class="main_black_bold">Test Details</legend>
																	<table id="table4" border="0" cellSpacing="1" cellPadding="1" width="100%" height="90">
                                                                    	<tr class="main_black_small" vAlign="top" align="left">
																			<td style="WIDTH: 128px" width="128">NAC USer ID:</td>
																			<td colSpan="2"><asp:textbox id="txtUsrtId" runat="server" MaxLength="9" onkeypress='validateNum(event)' CssClass="txtbox"></asp:textbox></td>
																		</tr>

																		<tr class="main_black_small" vAlign="top" align="left">
																			<td style="WIDTH: 128px" width="128">NAC Reg ID:</td>
																			<td colSpan="2"><asp:textbox id="txtRegId" runat="server" MaxLength="17" CssClass="txtbox"></asp:textbox></td>
																		</tr>
																		<tr class="main_black_small" vAlign="top" align="left">
																...
																<fieldset align="left"><legend class="main_black_bold">Test Locations</legend>
																	<table id="table9" border="0" cellSpacing="1" cellPadding="1" width="100%" height="49">
																		<tr class="main_black_small" vAlign="top" align="left">
																			...
																			<td align="left"><asp:dropdownlist id="ddlTestState" runat="server" CssClass="txtbox">
																					<asp:ListItem>Select</asp:ListItem>
																				</asp:dropdownlist></td>
																		</tr>
																	<tr class="main_black_small" vAlign="top" align="left">
																			<td width="90" align="left">Test City:</td>
																			<td align="left"><asp:dropdownlist id="ddlTestCity" runat="server" CssClass="txtbox">
                                                                            <asp:ListItem>Select</asp:ListItem>
																				</asp:dropdownlist></td>
																		</tr>
                                                                        	<tr class="main_black_small" vAlign="top" align="left">
																			<td width="90" align="left">Test Centre:</td>
																			<td align="left"><asp:dropdownlist id="ddlTestCentre" runat="server" CssClass="txtbox">
                                                                            	<asp:ListItem>Select</asp:ListItem>
                                                                                <%--<asp:ListItem Value="01">01</asp:ListItem>--%>
																				</asp:dropdownlist></td>
																	...
																	<table id="table11" border="0" cellSpacing="1" cellPadding="1" width="100%" height="15">
																		...
																		<TR class="main_black_small" vAlign="top" align="left">
																			...
																			<TD colSpan="2" align="left"><asp:dropdownlist id="ddlDOBdayFrom" CssClass="txtarea" Runat="server">
                                                                                ...
                                                                                <asp:dropdownlist id="ddlDOByearFrom" CssClass="txtarea" Runat="server">																	
																				</asp:dropdownlist></TD>
																		</TR>
																		<TR class="main_black_small" vAlign="top">
																			...
																			<TD colSpan="2" align="left"><asp:dropdownlist id="ddlDOBdayTo" CssClass="txtarea" Runat="server">
                                                                                ...
                                                                                <asp:dropdownlist id="ddlDOByearTo" CssClass="txtarea" Runat="server">																	
																				</asp:dropdownlist></TD>
																		</TR>
																		<tr class="main_black_small" vAlign="top" align="left">
																		...
																		<tr class="main_black_small" vAlign="top" align="left">
																			...
																			<td colSpan="2" align="left"><asp:dropdownlist id="ddlYearOfPassing12" CssClass="txtarea" Runat="server">																				</asp:dropdownlist></td>
																		</tr>
								...
								<TR class="main_black_small" vAlign="top" align="left">
									<TD style="WIDTH: 918px" vAlign="top" width="918" align="center"><asp:button id="btnSearch" runat="server" CssClass="button" EnableViewState="False" Text="Search"
								...
								<tr id="trChkAll" class="small_maroon" height="25" align="center">
									<td style="WIDTH: 918px" width="918" align="left">&nbsp;
										<asp:checkbox id="chkAll" onclick="CheckAllCandidate(); DeselectAll();" CssClass="chkbox" Runat="server"
											Text="Select All" Font-Bold="True"  oncheckedchanged="btnDeselectAll_Click"></asp:checkbox><asp:button id="btnDeselectAll" Runat="server" Width="1px" Visible="False" Height="1px"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr>
						<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:button id="btnCandidateDetails" runat="server" CssClass="button" Text="Candidate Details" onclick="btnCandidateDetails_Click"></asp:button>
							<asp:button id="btnScoreCard" runat="server" CssClass="button" Text="Score Card" onclick="btnScoreCard_Click"></asp:button>
							<asp:button id="btnExportToExcel" runat="server" CssClass="button" Text="Export To Excel" onclick="btnExportToExcel_Click"></asp:button>
							<asp:button id="btnAdmitCard" runat="server" CssClass="button" Text="Admit Card" onclick="btnAdmitCard_Click"></asp:button>
							<asp:button id="btnEditCandidateDetails" runat="server" CssClass="button" Text="Edit Details" onclick="btnEditCandidateDetails_Click"></asp:button>
							<asp:button id="btnSendMail" runat="server" CssClass="button" Text="Send Admit card" onclick="btnSendMail_Click"></asp:button>
							<asp:button id="btnDisableCandidate" runat="server" CssClass="button" Text="Disable Candidate" onclick="btnDisableCandidate_Click"></asp:button>
					...
					<tr>
						<td vAlign="top" align="center">
							<DIV class="landingFooter">
								<%--<DIV class="divLeft"><IMG src="../WEB/Images/footerDB.jpg">--%>
                                <uc1:nacyearlyfooter  ID="nacyearlyfooter" runat="server"></uc1:nacyearlyfooter>
                                </DIV>

                                <div ><A href="mailto:nac@nasscom.in"></A></div>
							</DIV>
						</td>
					</tr>
				</table>

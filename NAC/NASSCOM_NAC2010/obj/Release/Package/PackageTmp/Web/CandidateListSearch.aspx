...
<%@ Page language="c#" Codebehind="CandidateListSearch.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.CandidateListSearch" %>
...
<HTML>
	<HEAD>
	   ...
	   function SelectSingleCandidate()
	  {
	      ...
	      if(varSelectedCandidateCount > 0)
	      {
			if(varSelectedCandidateCount > 1)
			{
				 alert("Please select single candidate from candidate list");
				return false;
			}
			else
			{
	...
	function FillHiddenField()
	{
		...
		document.getElementById("hdTest").value = document.getElementById("ddlTest").selectedIndex;			
	}	
								...
								<td align="center"><br>
									<table id="Table4" height="100%" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<tr class="main_black" vAlign="top" align="left">
											<td vAlign="top" width="48%" colSpan="2">
												<fieldset align="left"><legend class="main_black_bold">Name</legend>
													<table height="40" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<tr class="main_black" vAlign="top" align="left">
															<td>First Name:</td>
															<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:textbox id="txtName" runat="server" MaxLength="30" Width="170px" CssClass="txtbox"></asp:textbox></td>
														</tr>
														<tr class="main_black" vAlign="top" align="left">
															<td>Last Name:</td>
															<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:textbox id="txtLastName" runat="server" MaxLength="30" Width="170px" CssClass="txtbox"></asp:textbox></td>
														</tr>
													</table>
												</fieldset>
											</td>
											...
											<td width="48%" colSpan="2">
												<fieldset align="left"><legend class="main_black_bold">Medium Of Instruction</legend>
													<table height="40" cellSpacing="1" cellPadding="1" width="100%" border="0">
														<tr class="main_black" vAlign="top" align="left">
															<td align="left">Upto 10th standard:</td>
															<td align="left"><asp:dropdownlist id="ddlMediumOfInstruction" CssClass="txtarea" Runat="server">
												...
												<fieldset align="left"><legend class="main_black_bold">Test Locations</legend>
													<table id="Table3" height="65" cellSpacing="1" cellPadding="1" width="100%" border="0">
														...
														<tr class="main_black" vAlign="top" align="left">
															...
															<td align="left"><asp:dropdownlist id="ddlTest" runat="server" CssClass="txtbox" name="ddlTest"></asp:dropdownlist></td>
														</tr>
														<tr class="main_black" vAlign="top" align="left">
												...
												<fieldset align="left"><legend class="main_black_bold">User ID/Registration ID</legend>
													<table height="65" cellSpacing="1" cellPadding="1" width="100%" border="0">
														...
														<tr class="main_black" vAlign="top" align="left">
															...
															<td style="HEIGHT: 23px" align="center"><asp:textbox id="txtSerialNoFrom" runat="server" MaxLength="30" Width="70px" CssClass="txtbox"></asp:textbox></td>
															<td style="HEIGHT: 23px" align="center">&nbsp;-&nbsp;</td>
															<td style="HEIGHT: 23px" align="center"><asp:textbox id="txtSerialNoTo" runat="server" MaxLength="30" Width="70px" CssClass="txtbox"></asp:textbox></td>
														</tr>
														<tr class="main_black" vAlign="top" align="left">
															<td>Registration ID:</td>
															<td align="center"><asp:textbox id="txtRegistrationIDFrom" runat="server" MaxLength="30" Width="70px" CssClass="txtbox"></asp:textbox></td>
															<td align="center">&nbsp;-&nbsp;</td>
															<td align="center"><asp:textbox id="txtRegistrationIDTo" runat="server" MaxLength="30" Width="70px" CssClass="txtbox"></asp:textbox></td>
														</tr>
													</table>
												</fieldset>
											</td>
												...
												<fieldset align="left"><legend class="main_black_bold">Personal Details</legend>
													<table height="110" cellSpacing="1" cellPadding="1" width="100%" border="0">
														...
														<tr class="main_black" vAlign="top" align="left">
															...
															<td align="left"><asp:textbox id="txtResidenceCity" MaxLength="100" CssClass="txtbox" Runat="server"></asp:textbox></td>
														</tr>
														<tr class="main_black" vAlign="top" align="left">
															<td colSpan="2">
												...
												<fieldset align="left"><legend class="main_black_bold">Scores
													...
													<table height="110" cellSpacing="1" cellPadding="1" width="100%" border="0">
														...
														<tr class="main_black" align="left">
															...
															<td align="center"><asp:textbox id="txtSpeakingFrom" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
															<td align="center">-</td>
															<td align="center"><asp:textbox id="txtSpeakingTo" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
														</tr>
														<tr class="main_black" align="left">
															<td align="left">Listening:</td>
															<td align="center"><asp:textbox id="txtListeningFrom" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
															<td align="center">-</td>
															<td align="center"><asp:textbox id="txtListeningTo" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
														</tr>
														<tr class="main_black" align="left">
															<td align="left">Writing:</td>
															<td align="center"><asp:textbox id="txtWaitingFrom" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
															<td align="center">-</td>
															<td align="center"><asp:textbox id="txtWaitingTo" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
														</tr>
														<tr class="main_black" align="left">
															<td align="left">A&amp;Q:</td>
															<td align="center"><asp:textbox id="txtAnalyticalFrom" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
															<td align="center">-</td>
															<td align="center"><asp:textbox id="txtAnalyticalTo" runat="server" MaxLength="2" Width="50px" CssClass="txtbox"></asp:textbox></td>
														</tr>
													</table>
												</fieldset>
											</td>
										...
										<tr class="main_black" vAlign="top" align="left">
												...
												<fieldset align="left"><legend class="main_black_bold">Educational Qualification
													...
													<table cellSpacing="1" cellPadding="1" width="100%" border="0">
														...
														<tr class="small_black" id="dvPostGraduate" style="DISPLAY: none" vAlign="top" align="left"
															...
															<td class="small_black" align="left"><asp:textbox id="txtHighestEducationObtainedFrom" MaxLength="50" CssClass="txtbox" Runat="server"></asp:textbox></td>
														</tr>
														<tr class="small_black" id="dvPostGraduate2" style="DISPLAY: none" vAlign="top" align="left"
															runat="server">
															<td align="left">College Address:</td>
															<td align="left"><asp:textbox id="txtCollegeAddress" runat="server" MaxLength="100" Width="250px" CssClass="txtarea"
																	Columns="30" Rows="4" TextMode="MultiLine"></asp:textbox></td>
														</tr>
														<tr class="small_black" id="dvPostGraduate1" style="DISPLAY: none" vAlign="top" align="left"
															runat="server">
															<td align="left">College City:</td>
															<td align="left"><asp:textbox id="txtHighestEducationCity" MaxLength="10" CssClass="txtbox" Runat="server"></asp:textbox></td>
														</tr>
														<tr class="main_black" align="left">
											...
											<td vAlign="middle" align="center" width="30%"><asp:button id="btnSearch" runat="server" Text="Search" EnableViewState="False" onclick="btnSearch_Click"></asp:button></td>
											<td width="2%"></td>
										</tr>
										<tr class="main_black" align="left">
										...
										<tr class="small_maroon" align="center" height="25">
											<td align="left" width="2%">&nbsp;<asp:checkbox id="chkAll" onclick="CheckAllCandidate(); DeselectAll();" CssClass="chkbox" Runat="server"
													Text="Select All" Font-Bold="True"></asp:checkbox><input id="hdTotalCandidateCount" type="hidden" value="0" runat="server" NAME="hdTotalCandidateCount"><asp:button id="btnDeselectAll" Width="1px" Runat="server" Height="1px"></asp:button></td>
										...
										<tr class="main_black" align="center">
											<td colSpan="6"><asp:panel id="pnlSearch" Runat="server">
													<asp:datagrid id="dgSearch" runat="server" CssClass="main_black" Width="100%" Height="100%" AllowSorting="True"
														ShowFooter="True" OnSortCommand="dgSearch_SortCommand" AutoGenerateColumns="False" BorderColor="#999999"
														BorderStyle="None" BorderWidth="1px" OnPageIndexChanged="dgSearch_PageIndexChanged" OnItemDataBound="dgSearch_ItemDataBound"
														OnItemCommand="dgSearch_ItemCommand" OnItemCreated="dgSearch_ItemCreated" BackColor="White"
										...
										<tr class="small_maroon" align="center">
											<td colSpan="6"><asp:panel id="pnlMessage" Runat="server">
													<asp:Label id="lblMessage" CssClass="small_maroon" Runat="server" Text="NO RECORDS FOUND!"
														Font-Bold="True" ForeColor="red" Visible="True"></asp:Label>
												</asp:panel></td>
										</tr>
										<tr align="center">
											<td align="left" colSpan="6">&nbsp;&nbsp;&nbsp;&nbsp;
												<asp:button id="btnDeActive" Runat="server" Text="Disable Reg." onclick="btnDeActive_Click"></asp:button><asp:button id="btnViewJobCard" runat="server" Text="Job Fair Card" onclick="btnViewJobCard_Click"></asp:button><asp:button id="btnCandidateDetails" runat="server" Text="Candidate Details" onclick="btnCandidateDetails_Click"></asp:button><asp:button id="btnScoreCard" runat="server" Text="Score Card" onclick="btnScoreCard_Click"></asp:button><asp:button id="btnAdmitCard" runat="server" Text="Admit Card" onclick="btnAdmitCard_Click"></asp:button><asp:button id="btnExportToExcel" runat="server" Text="Export To Excel" onclick="btnExportToExcel_Click"></asp:button>
												<asp:button id="btnSendMail" Runat="server" Text="Send Admit Card" Visible="True" onclick="btnSendMail_Click"></asp:button><asp:button id="btnEditCandidateDetails" Runat="server" Text="Edit Details" Visible="True" onclick="btnEditCandidateDetails_Click"></asp:button><asp:button id="btnMultipleScorecardPDF" Runat="server" Text="Score Card PDF" Visible="True" onclick="btnMultipleScorecardPDF_Click"></asp:button>
												<asp:label id="lblSortExp" Runat="server" Visible="False"></asp:label><input id="hdState" type="hidden" value="0" name="hdState" runat="server">
												...
												<input id="hdHeaderCheckBox" type="hidden" value="0" name="hdHeaderCheckBox" runat="server"><input id="hdSelectedCandidateCount" type="hidden" value="0" name="hdSelectedCandidateCount"
													runat="server"> <INPUT id="hdTest" type="hidden" value="0" name="hdTest" runat="server">
											</td>
										</tr>
										<tr class="small_maroon" align="center" height="25">
											<td colSpan="6">&nbsp;</td>

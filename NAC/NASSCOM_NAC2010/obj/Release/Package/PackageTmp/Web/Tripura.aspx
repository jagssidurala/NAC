...
<%@ Page language="c#" Codebehind="Tripura.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.Tripura" %>
														...
														<td>
															<table id="tblHeader1" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr vAlign="top" align="left">
																	...
																	<td align="right" background="images/header_bg.gif">&nbsp;<IMG id="imgStateLogo" height="85" src="images/Tripura.gif" runat="server">
																	</td>
																</tr>
															</table>
														</td>
																...
																<TBODY>
																	<TR>
																		<TD class="grey_bg main_black" vAlign="middle" align="left" height="30"><strong>Government 
																				of Tripura launches NAC</strong></TD>
																	</TR>
																	<TR>
																		<TD class="white_bg main_black" vAlign="top" align="left">
																			<p align="justify">Government of Tripura and NASSCOM (National Association of 
																				...
																				Government of Tripura, in association with NASSCOM, is the implementing body 
																				for the NAC Assessment. NAC is to become a national-level certification program 
																				and its very first administration at Tripura is being done which has <u>limited</u>
																				number of seats. This is open to all undergraduate and postgraduate students 
																				from any stream.
																			</p>
																			...
																			<p><strong>As the first administration of NAC is being subsidized by government, the 
																					assessment was made available to candidates for <font color="red">FREE.</font></strong>
																				<br>
																				<br>
																			</p>
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Govt. 
																										of Tripura announces the JOB FAIR for NAC candidates</strong></font> &nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><strong><br>
																								<span style="FONT-WEIGHT: bold; FONT-SIZE: 11px; FONT-FAMILY: Verdana">The first 
																									round of Tripura NAC successfully took place on 08 December 2007 at Agartala, 
																									Udaipur, Ambassa and Kailashahar where more than 2500 candidates took the test. 
																									The <u>score cards</u> and <u>job fair cards</u> for first round candidates are 
																									now available on the website.</span> </strong>
																							<hr>
																							<div align="center" style="COLOR: #cc0000"><strong>TRIPURA NAC JOB FAIR </strong>
																								<br>
																								<span style="FONT-SIZE: 12px"><strong><span style="COLOR: black">Date:</span> 18-19 
																										March-08 </strong></span>
																								<br>
																								<span style="FONT-SIZE: 12px"><strong><span style="COLOR: black">Venue:</span> Women's 
																										Polytechnic, Hapania, Tripura (West) - 799130</strong></span>
																								<br>
																								...
																								<tr>
																									...
																									<td style="FONT-SIZE: 11px; COLOR: #000099" align="left">
																										<ol>
																											...
																											<li>
																												<span><strong><a href="http://www.nac.nasscom.in/Time allocation sheet (Tripura).xls" target="_blank">
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Score 
																										cards for Tripura NAC are now available on this website </strong></font>
																								&nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																				...
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="blue_bg" vAlign="middle" height="25"><span class="main_white_bold"><span class="mainwhitebold1">First 
																									round of Tripura NAC</span></span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg"><strong>The first round of Tripura NAC successfully took place on 
																								08 December 2007 at Agartala, Udaipur, Ambassa and Kailashahar where more than 
																								2500 candidates took the test. </strong>
																							<br>
																							<br>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg" height="30"><br>
																							&nbsp;&nbsp;Open to all final-year undergraduate and all postgraduate students 
																							from all streams.<br>
																						</TD>
																					</TR>
																				</TBODY>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							...
																							<ol>
																								<li>
																								MBB College, Agartala, West Tripura District
																								<li>
																								Womens Polytechnic, Agartala, West Tripura District
																								<li>
																								Netaji Subhas Mahavidyalaya, Udaipur, South Tripura District
																								<li>
																								Chandraipara H S School, Ambassa, Dhalai District
																								<li>
																									Ramkrishna Mahavidyalaya, Kailashahar, North Tripura District
																								</li>
																							</ol>
																						</TD>
																					</TR>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99">
																							...
																							<ol>
																								<li>
																								0381-2324689 (Director, Higher Education)
																								<li>
																								0381-2324327 (Director, Employment Services &amp; Manpower Planning)
																								<li>
																									0381-2355751 (Director, IT) Email: <A href="mailto:it.tripura@gmail.com">it.tripura@gmail.com</A>
																								</li>
																							</ol>
																						</TD>
																						<br>

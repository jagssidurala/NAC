<%@ Page language="c#" Codebehind="Assam.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.Assam" %>
														...
														<td>
															<table id="tblHeader1" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr vAlign="top" align="left">
																	...
																	<td align="right" background="images/header_bg.gif">&nbsp;<IMG id="imgStateLogo" height="85" src="images/Rajasthan.gif" runat="server">
																	</td>
																</tr>
															</table>
														</td>
																...
																<TBODY>
																	<TR>
																		<TD class="grey_bg main_black" vAlign="middle" align="left" height="30"><strong>Government 
																				of Assam launches NAC</strong></TD>
																	</TR>
																	<TR>
																		<TD class="white_bg main_black" vAlign="top" align="left">
																			<p align="justify">Government of Assam and NASSCOM (National Association of 
																				Software and Service Companies) jointly introduce <SPAN class="big_maroon">NASSCOM 
																					Assessment of Competence (NAC)</SPAN> - an assessment-cum-certification program for candidates who aspire to be a part of the ITES-BPO industry. Assam Electronics Development Corporation Limited (AMTRON), a Govt. of Assam undertaking, in association with NASSCOM, is the implementing body for the NAC Test at Assam. NASSCOM, with active participation of ITES-BPO industry players, designed NAC, which is aimed at creating a robust and continuous pipeline of talent by transforming the "trainable" workforce into an "employable" workforce. As working with the ITES-BPO industry involves working primarily for global clients, that too in a global environment, the preferred language (medium of instruction) is English. 
																			</p>
																			<p><strong>NAC is to become a national-level certification program and its very first 
																					administration at Assam successfully took place in the month of December 07. 
																					This was open to all undergraduate, graduate and postgraduate students of any 
																					stream who wish to be employed with the ITES-BPO companies in future.</strong>
																			</p>
																			<p>As the first administration of NAC was being subsidized by government, the 
																				assessment was made available to candidates for<font color="red"><strong>&nbsp;FREE.</strong></font>
																				<br>
																				<br>
																			</p>
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Govt. 
																										of Assam announces the JOB FAIR for NAC candidates</strong></font> &nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><strong><br>
																								<span style="FONT-WEIGHT: bold; FONT-SIZE: 11px; FONT-FAMILY: Verdana">The first round of Assam NAC successfully took place on 19-23 December 2007 at 17 districts at Assam where more than 2500 candidates took the test. The <u>score cards</u> and <u>job fair 
																										cards</u> for first round candidates are now available on the website.</span>
																							</strong>
																							<hr>
																							<div align="center" style="COLOR: #cc0000"><strong>ASSAM NAC JOB FAIR </strong>
																								<br>
																								<span style="FONT-SIZE: 12px"><strong><span style="COLOR: black">Date:</span> 15-16 March-08
																									</strong></span>
																								<br>
																								<span style="FONT-SIZE: 12px"><strong><span style="COLOR: black">Venue:</span> Assam Engineering Institute, Chandmari, Guwahati - 781003</strong></span>
																								<br>
																								...
																								<tr>
																									...
																									<td style="FONT-SIZE: 11px; COLOR: #000099" align="left">
																										<ol>
																											...
																											<li>
																												<span><strong><a href="http://www.nac.nasscom.in/Time allocation chart (Assam).xls" target="_blank">
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Score 
																										cards for Assam NAC are now available on this website </strong></font>&nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><br>
																							...
																							&nbsp;&nbsp;&nbsp;&nbsp;<strong><u>To print your NAC score card, follow the 
																								...
																								&nbsp;&nbsp;&nbsp;<i>- Paper size: A4
																									...
																									&nbsp;&nbsp;&nbsp;- Orientation: Portrait
																									<br>
																									&nbsp;&nbsp;&nbsp;- Margins: Left 0.75, Right 0.75, Top 0.75, Bottom 0.16</i>
																							</span>
																							<br>
																						</TD>
																					</TR>
																				...
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="blue_bg" vAlign="middle" height="25"><span class="main_white_bold"><span class="mainwhitebold1">First 
																									round of Assam NAC</span></span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg"><strong>The first round of Assam NAC successfully took place on 19-23 December 2007 at 17 districts at Assam where more than 2500 candidates took the test.  </strong>
																							<br>
																							<br>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg" height="30"><br>
																							<ul>
																								<li>
																								Students pursuing final year UG (all streams)
																								<li>
																								Graduates (all streams)
																								<li>
																									Post-Graduates (all streams)
																								</li>
																							</ul>
																						</TD>
																					</TR>
																			...
																			<TABLE class="grey_bg" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="lightblue_bg" vAlign="middle" height="25"><span class="main_blue_bold">Test districts where NAC was administered</span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							<TABLE width="100%" border="0" align="center" cellPadding="3" cellSpacing="1">
																								<tr>
																									<td width="5%" class="main_black">1.</td>
																									<td align="left" width="45%" class="main_black">Barpeta</td>
																									<td width="5%" class="main_black">10.</td>
																									<td align="left" width="45%" class="main_black">Kokrajhar</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">2.</td>
																									<td align="left" width="45%" class="main_black">Bongaigaon</td>
																									<td width="5%" class="main_black">11.</td>
																									<td align="left" width="45%" class="main_black">Lakhimpur</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">3.</td>
																									<td align="left" width="45%" class="main_black">Demaji</td>
																									<td width="5%" class="main_black">12.</td>
																									<td align="left" width="45%" class="main_black">Mangaldoi</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">4.</td>
																									<td align="left" width="45%" class="main_black">Dhubri</td>
																									<td width="5%" class="main_black">13.</td>
																									<td align="left" width="45%" class="main_black">Nagaon</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">5.</td>
																									<td align="left" width="45%" class="main_black">Dibrugarh</td>
																									<td width="5%" class="main_black">14.</td>
																									<td align="left" width="45%" class="main_black">Nalbari</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">6.</td>
																									<td align="left" width="45%" class="main_black">Diphu</td>
																									<td width="5%" class="main_black">15.</td>
																									<td align="left" width="45%" class="main_black">Sibsagar</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">7.</td>
																									<td align="left" width="45%" class="main_black">Guwahati</td>
																									<td width="5%" class="main_black">16.</td>
																									<td align="left" width="45%" class="main_black">Silchar</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">8.</td>
																									<td align="left" width="45%" class="main_black">Haflong</td>
																									<td width="5%" class="main_black">17.</td>
																									<td align="left" width="45%" class="main_black">Tezpur</td>
																								</tr>
																								<tr>
																									<td width="5%" class="main_black">9.</td>
																									<td align="left" width="45%" class="main_black">Jorhat</td>
																									<td width="5%" class="main_black"></td>
																									<td align="left" width="45%" class="main_black"></td>
																								</tr>
																							</TABLE>
																						</TD>
																					</TR>
																			...
																			<TABLE class="grey_bg" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99">
																							<br>
																							<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sh. T.N.D. Sarmah<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Assam Electronics Development Corporation 
																								Ltd. (AMTRON)
																								<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Phone: 0361-2724221<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <A href="mailto:tnd.sarmah@amtron.in">tnd.sarmah@amtron.in</A></strong><br>
																							<br>
																						</TD>
																						<br>
																					</TR>
																			...
																			<TABLE class="grey_bg" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<td class="lightblue_bg" vAlign="middle" height="25"><strong>Please visit <a style="FONT-WEIGHT: bold; COLOR: #0000ff; TEXT-DECORATION: none" href="http://www.nac.nasscom.in"

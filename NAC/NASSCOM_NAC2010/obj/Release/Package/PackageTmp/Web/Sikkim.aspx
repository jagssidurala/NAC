...
<%@ Page language="c#" Codebehind="Sikkim.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.Sikkim" %>
														...
														<td>
															<table id="tblHeader1" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<tr vAlign="top" align="left">
																	...
																	<td align="right" background="images/header_bg.gif">&nbsp;<IMG id="imgStateLogo" height="85" src="images/Sikkim.gif" runat="server">
																	</td>
																</tr>
															</table>
														</td>
																...
																<TBODY>
																	<TR>
																		<TD class="grey_bg main_black" vAlign="middle" align="left" height="30"><strong>Government 
																				of Sikkim launches NAC</strong></TD>
																	</TR>
																	<TR>
																		<TD class="white_bg main_black" vAlign="top" align="left">
																			<p align="justify">Government of Sikkim and NASSCOM (National Association of 
																				...
																				program for candidates who aspire to be a part of the ITES-BPO 
																				industry.Department of Information Technology (DIT), Government of Sikkim, in 
																				association with NASSCOM, is the implementing body for the NAC Assessment. 
																			...
																			<p><strong>NAC is to become a national-level certification program and its very first 
																					administration at Sikkim successfully took place in the month of November 07. 
																					This was open to all undergraduate and postgraduate students from any stream. </strong>
																			</p>
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Govt. 
																										of Sikkim announces the JOB FAIR for NAC candidates</strong></font> &nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><strong><br>
																								<span style="FONT-WEIGHT: bold; FONT-SIZE: 11px; FONT-FAMILY: Verdana">The first round of Sikkim NAC successfully took place on 
																								30 November 2007 at Gangtok and Namchi where more than 150 candidates took the 
																								test. The <u>score cards</u> and <u>job fair 
																										cards</u> for first round candidates are now available on the website.</span>
																							</strong>
																							<hr>
																							<div align="center" style="COLOR: #cc0000"><strong>SIKKIM NAC JOB FAIR </strong>
																								<br>
																								...
																								<tr>
																									...
																									<td style="FONT-SIZE: 11px; COLOR: #000099" align="left">
																										<ol>
																											...
																											<li>
																												<span><strong><a href="http://www.nac.nasscom.in/Time allocation chart (Sikkim).xls" target="_blank">
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Score 
																										cards for Sikkim NAC are now available on this website </strong></font>&nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																				...
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="blue_bg" vAlign="middle" height="25"><span class="main_white_bold"><span class="mainwhitebold1">First 
																									round of Sikkim NAC</span></span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg"><strong>The first round of Sikkim NAC successfully took place on 
																								30 November 2007 at Gangtok and Namchi where more than 150 candidates took the 
																								test. </strong>
																							<br>
																							<br>
																			...
																			<TABLE class="grey_bg" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg" height="30">&nbsp;&nbsp;&nbsp;&nbsp;Open to all final-year 
																							undergraduates, graduates and postgraduates from any stream.
																						</TD>
																					</TR>
																				</TBODY>
																			</TABLE>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							<ol>
																								...
																								<li>
																									District Administrative Center, IT Department, Namchi, South Sikkim
																								</li>
																							</ol>
																						</TD>
																					</TR>
																				...
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg">
																							...
																							<ol>
																								<li>
																									Mr. Rajesh Verma, Director, IT Department, Govt. of Sikkim<br>
																									Tel: (03592)-202601 &amp; Fax: 227426<br>
																									Mobile: 9434186291<br>
																									Email: <A href="mailto:vermar@nic.in">vermar@nic.in</A><br>
																									<br>
																								<li>
																									Mr. Tsering Samdup,Deputy Director, IT Department, Govt. of Sikkim<br>
																									Tel: (03592)-202601 Fax:227426<br>
																									Mobile: 9434179192<br>
																									email: <A href="mailto:t.samdup@nic.in">t.samdup@nic.in</A><br>
																									<br>
																								<li>
																									Mr. Mihir Pradhan, Computer Operator, CIC, Namchi<br>
																									Mobile: 9832070612<br>
																									<br>
																								</li>
																							</ol>

<%@ Page language="c#" Codebehind="JobFairCard_MT.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.JobFairCard_MT" %>
																...
																<TR>
																	<TD vAlign="top" align="left" width="76%">
																		<TABLE class="grey_bg" cellSpacing="0" cellPadding="5" width="100%" border="1">
																			<TR class="main_black" id="TrGroup" vAlign="top" align="left" runat="server">
																		...
																		<TABLE class="blue_bg" cellSpacing="0" cellPadding="5" width="100%" border="1">
																			...
																			<TR class="main_black" vAlign="top" align="left">
																				<TD class="white_bg">Writing(Multiple Choice):</TD>
																				<TD class="white_bg">
																					<asp:Label id="lblWriting" runat="server"></asp:Label>&nbsp;</TD>
																			</TR>
																			<TR class="main_black" vAlign="top" align="left">
																				<TD class="white_bg">Writing(Essay):</TD>
																				<TD class="white_bg">
																					<asp:Label id="lblWritingEssay" runat="server"></asp:Label>&nbsp;</TD>
																			</TR>
																			<TR class="main_black" vAlign="top" align="left">
																			...
																			<TR class="main_black" vAlign="top" align="left">
																				<TD class="white_bg">Learning Ability:</TD>
																				<TD class="white_bg">
																					<asp:Label id="lblLearningAbility" runat="server"></asp:Label>&nbsp;</TD>
																			</TR>
																			<TR class="main_black" vAlign="top" align="left">
																				<TD class="white_bg">Keyboard Skills:</TD>
																				<TD class="white_bg">
																					<asp:Label id="lblKeyboardSkills" runat="server"></asp:Label>&nbsp;</TD>
																			</TR>
																		</TABLE>
																	</TD>
																...
																<HeaderTemplate>
																	<table cellSpacing="0" cellPadding="0" width="100%" border="1">
																		<TR class="grey_bg" vAlign="top" align="left">
																			<TD class="main_black" width="8%" align="left"><STRONG>&nbsp;&nbsp;S.No. </STRONG>
																			<TD class="main_black" width="32%" align="left"><STRONG>&nbsp;&nbsp;Name of the company </STRONG>
																			<TD class="main_black" width="14%" align="left"><STRONG>&nbsp;&nbsp;Attended(Y/N)</STRONG></TD>
																			<TD class="main_black" width="49%" align="left"><STRONG>&nbsp;&nbsp;Signature of 
																					company personnel </STRONG>
																		</TR>
																	</table>
																</HeaderTemplate>
																<ItemTemplate>

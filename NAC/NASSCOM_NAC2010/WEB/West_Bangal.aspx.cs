...
{
	/// <summary>
	/// Summary description for West_Bangal.
	/// </summary>
	public partial class West_Bangal : System.Web.UI.Page
	{
...
//					if(Convert.ToInt32(Session["StateId"]) == 3)
//					{
...
//					}
			...
			else
			{
				...
				if(dsStateDetail.Tables[0].Rows.Count > 0)
				{
					...
					strStateLogo = Convert.ToString(dsStateDetail.Tables[0].Rows[0]["Logo"]);
					Session["StateLogo"] = strStateLogo;
//					if(Request.QueryString["State"].ToString().Trim() == "West Bengal")
//					{
//						Response.Redirect("PinLogin.aspx");
//					}

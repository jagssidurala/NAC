...
<%@ Page language="c#" Codebehind="CandidateList.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.CandidateList" %>
									...
									<table id="Table4" height="100%" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<tr class="small_maroon" align="center" height="25">
											<td align="left" width="2%">&nbsp;<asp:checkbox id="chkAll" onclick="CheckAllCandidate(); DeselectAll();" CssClass="chkbox" Runat="server"
													Text="Select All" Font-Bold="True"></asp:checkbox><input id="hdTotalCandidateCount" type="hidden" value="0" runat="server"><asp:button id="btnDeselectAll" Width="1px" Runat="server" Height="1px"></asp:button></td>

							...
							<td width="200" align="left">
								...
								<div id="divAdmin" runat="server">
									<table border="0" cellSpacing="2" cellPadding="5" width="100%">
                                        ...
                                        <tr class="main_black" align="center">
											<td noWrap align="left"><A id="A3" href="UpdateTestCapacityandShiftCapcity.aspx" src="Shift-wise Registered count" alt="Shift-wise Registered count">Update Test Capacity and Shift Capacity count</A></td>
										</tr>
                                          <tr class="main_black" align="center">
											<td noWrap align="left"><A id="A4" href="UpdateTestDate.aspx" src="Shift-wise Registered count" alt="Shift-wise Registered count">Update Test Date </A></td>
										</tr>
                                        <tr class="main_black" align="center">
											<td noWrap align="left"><A id="A5" href="GetStateWiseDetailsReport.aspx" src="State-wise registred count " alt="State-wise registred count">State-wise Registered Details Count </A></td>
										</tr>
										<tr class="main_black" align="center">

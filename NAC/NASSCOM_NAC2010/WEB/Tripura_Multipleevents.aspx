<%@ Page language="c#" Codebehind="Tripura_Multipleevents.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.Web.Tripura_Multipleevents" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>Tripura_Multipleevents</title>
											...
											<ItemTemplate>
												<table width="100%" border="1" bordercolor="#FF9933" cellpadding="5" cellspacing="0" id="tblLinks">
													<tr>
														...
														<a href="Tripura_SingleEvent.aspx?code=<%# DataBinder.Eval(Container.DataItem, 'TestId') %>">

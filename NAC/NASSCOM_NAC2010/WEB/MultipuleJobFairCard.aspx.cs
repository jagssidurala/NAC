...
namespace NASSCOM_NAC.Web
{
	...
	/// </summary>
	public partial class MultipuleJobFairCard : System.Web.UI.Page
	{
		...
		private void CreateMultipleJobFairCard(string strItemList, string strSortExp)
		{
			try
			{
				...
				dvJobFairCard = oBLScoreCard.GenerateMultipleScoreCardforJobCard(strItemList).DefaultView; 
		...
		private void CreateAllMultipleJobFairCard(BLSearch objBLSearch, string strSortExp)
		{
			...
			{				
				DataView dvJobFairCard = new DataView();
				dvJobFairCard = objBLSearch.GenerateAllMultipleJobAdmitCard().Tables[0].DefaultView; 
				dvJobFairCard.Sort = strSortExp;				

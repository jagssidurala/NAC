...
{
    /// <summary>
    /// Summary description for NagalandMessage.
    /// </summary>
    public partial class NagalandMessage : System.Web.UI.Page
    {
        ...
        private void SendMailWithPDF(string strEmailId, string strCandidateName, string strPhotoIDDocument, string strPhotoIDDocumentNumber, string strPassword, string strRegistrationID)
        {
            ...
            try
            {
                ...
                EmailBody += "</tr>";
                EmailBody += "<tr>";
                EmailBody += "<td colspan=3><p><span style=FONT-SIZE:9.0pt;FONT-FAMILY:Arial>Please note, your NAC Admission Card will be available on NAC website from <font color=#6633ff>23-Oct-07</font> onwards - do visit the website accordingly. </span></p></td>";
                EmailBody += "</tr>";
                EmailBody += "<tr>";

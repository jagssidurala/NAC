...
<%@ Page language="c#" Codebehind="MultipleTestScore.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.MultipleTestScore" %>
						...
						<TR>
							...
							<TD vAlign="top" align="right">
								<DIV id="NoPrint"><INPUT id="iPrint" onclick="PrintReport();" type="button" value="Print" name="iPrint" runat="server">
									<INPUT id="goBack" onclick="javascript:history.go(-1);" type="button" value="Back" name="goBack"
										runat="server"></DIV>
								&nbsp;<BR>								
																						...
																						<td valign="top">
																							<TABLE cellSpacing="0" cellPadding="5" border="0" width="100%">
																								...
																								<tr valign="top" align="center">
																									<td align="center" valign="top">
																										<span class="H2_BA"><u>NAC - NASSCOM Assessment of Competence</u></span>
																									</td>
																								</tr>
																								<tr valign="top" align="center">
																									<td align="center" valign="top">
																								...
																								<tr valign="top" align="center">
																									<td>
																										...
																										<TABLE class="blue_bg" cellSpacing="0" cellPadding="0" width="70%" border="1" bordercolorlight="#000000">
																								...
																								<tr valign="top" align="center">
																									<td align="center" valign="top">
																										...
																										<TABLE class="blue_bg" cellSpacing="0" cellPadding="0" width="90%" border="1" bordercolorlight="#000000">
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Voice 
																														Clarity</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																												...
																												<TD width="25%" bgcolor="#ffffff" align="center" rowspan="5"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "SpeakingPercentile") %>
																													</span>
																												</TD>
																											</TR>
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Accent</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "SpeakingMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Fluency</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "SpeakingMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Grammar</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "SpeakingMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Prosody</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "SpeakingMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												...
																												<TD width="25%" bgcolor="#ffffff" align="center" rowspan="4"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "WritingEssayPercentile") %>
																													</span>
																												</TD>
																											</TR>
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Content</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "WritingEssayMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Vocabulary</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "WritingEssayMaxScore") %>
																													</span>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">Spelling 
																														&amp; Punctuation</span>
																												</TD>
																												<TD width="25%" bgcolor="#ffffff" align="center"><span class="main_small_BA">
																														<%# DataBinder.Eval(Container.DataItem, "WritingEssayMaxScore") %>
																											...
																											<TR class="white_bg" vAlign="middle" align="center">
																												<TD width="50%" bgcolor="#ffffff" align="center" colspan="2"><span class="main_small_BA">
																								...
																								<td align="center" valign="top">
																									<TABLE class="blue_bg" cellSpacing="0" cellPadding="5" width="90%" border="1" bordercolorlight="#000000">
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Excellent</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Requires 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Good</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Requires 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Above 
																														Average</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">May 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Average</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">May 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Below 
																														Average</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Requires 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Poor</strong></span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Requires 
																								...
																								<td align="center" valign="top">
																									<TABLE class="blue_bg" cellSpacing="0" cellPadding="5" width="90%" border="1" bordercolorlight="#000000">
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Excellent:</strong>
																													Advanced level language user</span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">No 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Good:</strong>
																													Proficient level language user</span>
																											</TD>
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Makes 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA">Makes a 
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Average:</strong>
																										...
																										<TR class="white_bg" vAlign="middle" align="center">
																											...
																											<TD width="45%" bgcolor="#ffffff" align="left"><span class="main_small_UNB_BA"><strong>Poor:</strong>

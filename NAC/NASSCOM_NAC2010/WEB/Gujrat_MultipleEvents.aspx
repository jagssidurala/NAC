<%@ Page language="c#" Codebehind="Gujrat_MultipleEvents.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.Web.Gujrat_MultipleEvents" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>Gujrat_MultipleEvents</title>
							...
							<TBODY>
								<tr>
									<td rowspan="9">
										&nbsp;</td>
									<td valign="top">
										<img src="Images/HeaderLanding.jpg" width="957"></td>
											...
											<ItemTemplate>
												<table width="100%" border="1" bordercolor="#FF9933" cellpadding="5" cellspacing="0" id="tblLinks">
													<tr>
														...
														<a href="Gujrat_SingleEvent.aspx?code=<%# DataBinder.Eval(Container.DataItem, "TestId") %>">

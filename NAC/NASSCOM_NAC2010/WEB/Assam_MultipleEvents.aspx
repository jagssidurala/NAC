<%@ Page language="c#" Codebehind="Assam_MultipleEvents.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.Web.Assam_MultipleEvents" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>Assam_MultipleEvents</title>
											...
											<ItemTemplate>
												<table width="100%" border="1" bordercolor="#FF9933" cellpadding="5" cellspacing="0" id="tblLinks">
													<tr>
														...
														<a href="Assam_SingleEvent.aspx?code=<%# DataBinder.Eval(Container.DataItem, 'TestId') %>">

...
//		   document.getElementById("filUpload").outerHTML = "<input name='filUpload' id='filUpload' type='file' class='btn2' size='40'>";
			...
			function ValidateData()
			{
				...
				else if(document.getElementById("ddlGraduationYear").value != '0' && document.getElementById("ddlPassingYear12th").value != '0')
				{
				//alert(document.getElementById("ddlGraduationYear").value - document.getElementById("ddlPassingYear12th").value);
					if(document.getElementById("ddlQualification").value == '1')
					 ...
					 else if(document.getElementById("ddlQualification").value == '3')
					 {
					...
					<td vAlign="top" align="center">
						<TABLE class="black_bg" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TBODY>
								...
								<TR class="blue_bg" vAlign="top" align="left">
									<TD>
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR class="blue_bg" vAlign="top" align="left">
												<TD class="header1" vAlign="top" align="left">&nbsp;&nbsp;Registration Form&nbsp;
													<asp:label id="lblStateName" Runat="server"></asp:label></TD>
												<TD class="header1" vAlign="middle" align="right"><A class="header1" href="../Default.aspx">Exit&nbsp;&nbsp;</A></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
								<TR class="white_bg" vAlign="top" align="left">
									<TD align="center"><BR>
										<TABLE id="Table4" border="0" cellSpacing="0" cellPadding="3" width="85%">
											<TR>
												<TD colSpan="3">
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD width="55%">
													<asp:textbox id="txtFirstName" Runat="server" CssClass="txtbox" MaxLength="30" BackColor="White"></asp:textbox></TD>
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtMiddleName" Runat="server" CssClass="txtbox" MaxLength="30" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												<TD>Last Name:<FONT class="small_maroon">*</FONT></TD>
												<TD>
													<asp:textbox id="txtLastName" Runat="server" CssClass="txtbox" MaxLength="30" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtCity" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												<TD>Pincode:<FONT class="small_maroon">*</FONT></TD>
												<TD>
													<asp:textbox id="txtPinCode" Runat="server" CssClass="txtbox" MaxLength="6" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD><FONT class="rblbox">(STD Code)</FONT>
													...
													<asp:textbox id="txtPhoneNumber" Runat="server" CssClass="txtbox" MaxLength="10" BackColor="White"></asp:textbox>&nbsp;
												</TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtCellPhone" Runat="server" CssClass="txtbox" MaxLength="10" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon">&nbsp;</TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												<TD>Upload Photograph:
												</TD>
												<TD colSpan="2"><INPUT id="filUpload" class="btn2" size="40" type="file" name="filUpload" runat="server">&nbsp;
											...
											<TR>
												<TD class="small_maroon" colSpan="3"><FONT class="small_maroon">*</FONT> To upload 
													...
													computer where you have saved the photograph. It must be in .jpg, .jpeg or .gif 
													format only.</TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												<TD>Email Id:
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD style="HEIGHT: 24px">
													<asp:textbox id="txtMothersName" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox></TD>
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtFathersName" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
											...
											<TR style="DISPLAY: none" id="dvPostGraduate" class="small_black" vAlign="top" align="left">
												<TD style="HEIGHT: 19px" id="divHighestEducationObtainedFrom" align="right" runat="server"></TD>
											...
											<TR style="DISPLAY: none" id="dvHighEduYear" class="small_black" vAlign="top" align="left">
											...
											<TR style="DISPLAY: none" id="dvPGSpecialization" class="small_black" vAlign="top" align="left">
												<TD id="Td3" align="right">Specialization in PG:</TD>
												<TD align="left">
											...
											<TR style="DISPLAY: none" id="dvPostGraduate2" class="small_black" vAlign="top" align="left">
												<TD align="right">College Address:<FONT class="small_maroon">*</FONT>
												</TD>
											...
											<TR style="DISPLAY: none" id="dvPostGraduate1" class="small_black" vAlign="top" align="left">
												<TD align="right">College City:<FONT class="small_maroon">*</FONT></TD>
												<TD align="left">
													<asp:textbox id="txtHighestEducationCity" Runat="server" CssClass="txtbox" MaxLength="10" BackColor="White"></asp:textbox><FONT class="small_maroon"></FONT></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtPercentageScored" Runat="server" CssClass="txtbox" MaxLength="5" BackColor="White"
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD class="small_maroon">
													<asp:textbox id="txtCurrentLocation" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox>(city 
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD class="small_maroon">
													<asp:textbox id="txtLanguageSkills" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox>(language 
											...
											<TR id="dvPassport1" class="main_black" vAlign="top" align="left" runat="server">
												...
												<TD>
													<asp:textbox id="txtPassport" Runat="server" CssClass="txtbox" MaxLength="50" BackColor="White"></asp:textbox><!--<input id="Hidden1" type="hidden" value="0" name="hdPassport" runat="server">--></TD>
												<TD class="small_maroon"></TD>
											</TR>
											<TR class="main_black" vAlign="top" align="left">
												<TD>&nbsp;</TD>
											...
											<TR id="trTestCity" class="main_black" vAlign="top" align="left" runat="server">
												...
												<TD>
													<DIV id="divDropTestCity" runat="server">
														<asp:dropdownlist id="ddlTestCity" Runat="server" CssClass="txtarea" BackColor="White" AutoPostBack="False"></asp:dropdownlist><SPAN class="small_maroon"><I>(please 
																select city) </I><SPAN>
													</DIV>
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD class="small_maroon">
													<asp:textbox id="txtPassword" Runat="server" CssClass="txtbox" MaxLength="8" BackColor="White"
											...
											<TR class="main_black" vAlign="top" align="left">
												...
												<TD>
													<asp:textbox id="txtConfirmPassword" Runat="server" CssClass="txtbox" MaxLength="8" BackColor="White"
											...
											<TR>
												<TD style="HEIGHT: 25px" class="small_maroon" colSpan="3">* Your photograph on the 
											...
											<TR class="main_black" vAlign="top" align="left">
												<TD style="HEIGHT: 22px" colSpan="3"><FONT class="small_maroon">*</FONT>
													<asp:checkbox id="chkAuthorization" runat="server" Text=""></asp:checkbox>&nbsp;<SPAN style="FONT-SIZE: 12px; COLOR: #7f7f7f; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif">
														I authorize NASSCOM to share all my details, as indicated in the Registration 
														Form, and my &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;test 
														scores with prospective employers who are interested to look at my profile for 
														&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; 

<%@ Page language="c#" Codebehind="MessageState.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.MessageState" %>
							...
							<tr class="white_bg" vAlign="top" align="center">
								<td align="center"><br>
									<table width="90%" cellspacing="1" cellpadding="0" class="lightblue_bg" border="0">
										<tr>
											<td class="white_bg">
												<div class="main_blue_bold">
													Dear&nbsp;<asp:Label ID="lblCandidateName" class="main_blue_bold" Runat="server"></asp:Label>
												</div>
												<br>
												<table width="100%" border="0" ID="Table1">
													<tbody>
														<tr valign="top">
															<td class="main_grey_bold" colspan="2" style="HEIGHT: 39px"><p align="left">
																<p>
																	Second round of Gujarat NAC stands postponed
																</p>
																<p>Thank you
																</p>
															</td>

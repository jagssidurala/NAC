	...
	public partial class TestScore : System.Web.UI.Page
	{
		...
		private void GetTestScore()
		{
			try
			{
				...
				if (dsTestScore.Tables[0].Rows.Count > 0)
				{
					...
					lblWritingMultipleChoicePercentageScore.Text = Convert.ToString(dsTestScore.Tables[0].Rows[0]["WritingPercentage"]).Trim();
					...
					lblListeningPercentageScore.Text = Convert.ToString(dsTestScore.Tables[0].Rows[0]["ListeningPercentage"]).Trim();
					...
					lblAQRPercentageScore.Text = Convert.ToString(dsTestScore.Tables[0].Rows[0]["AQRPercentage"]).Trim();
					...
					lblLearningAbilityPercentageScore.Text = Convert.ToString(dsTestScore.Tables[0].Rows[0]["LAPercentage"]).Trim();
					...
					lblKeyboardSkillsAccuracy.Text = Convert.ToString(dsTestScore.Tables[0].Rows[0]["KeyboardAccuracy"]).Trim();
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			if(RegistrationId!= null)
			{
				...
				bool typeflag; 
				typeflag=objBLGenerateTestScore.GenerateScoreCardPDF(RegistrationId);				 

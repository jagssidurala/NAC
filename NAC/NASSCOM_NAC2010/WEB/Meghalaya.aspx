...
<%@ Page language="c#" Codebehind="Meghalaya.aspx.cs" AutoEventWireup="True" Inherits="NASSCOM_NAC.Web.Meghalaya" %>
																...
																<TBODY>
																	<TR>
																		<TD class="grey_bg main_black" vAlign="middle" align="left" height="30"><strong>Government 
																				of Meghalaya launches NAC</strong></TD>
																	</TR>
																	<TR>
																		<TD class="white_bg main_black" vAlign="top" align="left">
																			<p align="justify">Government of Meghalaya and NASSCOM (National Association of 
																				...
																				Department of Information Technology (DIT), Government of Meghalaya, in 
																				association with NASSCOM, is the implementing body for the NAC Test. NASSCOM, 
																				with active participation of ITES-BPO industry players, designed NAC, which is 
																				aimed at creating a robust and continuous pipeline of talent by transforming 
																				the "trainable" workforce into an "employable" workforce. As working with the 
																			...
																			<p><strong>NAC is to become a national-level certification program and its very first 
																					administration at Meghalaya successfully took place in the month of December 
																					07. This was open to all undergraduate, graduate and postgraduate students of 
																					any stream who wish to be employed with the ITES-BPO companies in future.</strong>
																			</p>
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Govt. 
																										of Meghalaya announces the JOB FAIR for NAC candidates</strong></font> &nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99"><strong><br>
																								<span style="FONT-WEIGHT: bold; FONT-SIZE: 11px; FONT-FAMILY: Verdana">The first round of Meghalaya NAC successfully took place 
																								on 08 December 2007 at Shillong &amp; Jowai where more than 500 candidates took 
																								the test. The <u>score cards</u> and <u>job fair 
																										cards</u> for first round candidates are now available on the website.</span>
																							</strong>
																							<hr>
																							<div align="center" style="COLOR: #cc0000"><strong>MEGHALAYA NAC JOB FAIR </strong>
																								<br>
																								...
																								<tr>
																									...
																									<td style="FONT-SIZE: 11px; COLOR: #000099" align="left">
																										<ol>
																											...
																											<li>
																												<span><strong><a href="http://www.nac.nasscom.in/Time allocation chart (Meghalaya).xls" target="_blank">
																					...
																					<TR vAlign="top" align="left">
																						<TD>
																							<marquee scrollDelay="5" behavior="scroll" loop="100"><font style="FONT-SIZE: 12px; COLOR: #ffffff; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><strong>Score 
																										cards for Meghalaya NAC are now available on this website </strong></font>
																								&nbsp;&nbsp;</marquee>
																						</TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																				...
																				<TBODY>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="blue_bg" vAlign="middle" height="25"><span class="main_white_bold"><span class="mainwhitebold1">First 
																									round of Meghalaya NAC</span></span></TD>
																					</TR>
																					<TR class="main_black" vAlign="top" align="left">
																						<TD class="white_bg"><strong>The first round of Meghalaya NAC successfully took place 
																								on 08 December 2007 at Shillong &amp; Jowai where more than 500 candidates took 
																								the test. </strong>
																							<br>
																							<br>
																			...
																			<TABLE class="grey_bg" cellSpacing="1" cellPadding="3" width="95%" align="center" border="0">
																				<TBODY>
																					...
																					<TR class="main_black" vAlign="top" align="left">
																						<TD bgColor="#ffff99">
																							<br>
																							<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mr. Wonshondro L Buam<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Special Officer to Government of Meghalaya, 
																								Dept. of IT<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile: 09863043183<br>
																								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <A href="mailto:wlbuam@rediffmail.com">wlbuam@rediffmail.com</A></strong><br><br>
																						</TD>
																						<br>
																					</TR>
																				</TBODY>

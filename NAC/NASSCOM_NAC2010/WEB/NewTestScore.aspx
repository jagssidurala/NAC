<%@ Page language="c#" Codebehind="NewTestScore.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.Web.NewTestScore" %>
						...
						<TABLE id="FirstPage" cellSpacing="0" cellPadding="35" border="1" bordercolor="#000000"
							...
							<tr valign="top">
								<td align="center" valign="top">
									...
									<asp:Button id="btnBackTop" runat="server" Text="Back"></asp:Button><br>
																		...
																		<td align="center" valign="top">
																			...
																			<TABLE cellSpacing="0" cellPadding="0" width="90%" border="1" bordercolorlight="#000000">
																				...
																				<TR vAlign="middle" align="center">
																					...
																					<TD width="25%" align="center" rowspan="5"><span class="main_small_BA"><asp:Label ID="lblSpeakingPercentage" Runat="server"></asp:Label></span>
																					</TD>
																				</TR>
																				<TR vAlign="middle" align="center">
																				...
																				<TR vAlign="middle" align="center" id="WritingEssay3" runat="server">
																					...
																					<TD width="25%" align="center" rowspan="4"><span class="main_small_BA"><asp:Label ID="lblWritingEssayPercentageScore" Runat="server"></asp:Label></span>
																					</TD>
																				</TR>
						...
						<TABLE id="SecondPage" cellSpacing="0" cellPadding="35" border="1" bordercolor="#000000"
							...
							<tr>
								<td align="center">
									...
									<asp:Button id="btnSaveBottom" runat="server" Text="Save"></asp:Button>
									<asp:Button id="btnBackBottom" runat="server" Text="Back"></asp:Button>
								</td>
							</tr>
						</TABLE>
					</td>

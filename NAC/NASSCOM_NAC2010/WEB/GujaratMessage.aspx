...
<%@ Page language="c#" Codebehind="GujaratMessage.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.Web.GujaratMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Gujarat Test Message</title>
														...
														<tr valign="top">
															<td class="main_black" colspan="2"><p align="left">
																...
																<p>These details will also be required by you later to access your NAC Admission 
																	Card / Score Card.</p>
																<p><strong>Please note -</strong> your NAC Admission Card will be available on NAC 
																	website from <font color="#000000" style="TEXT-DECORATION: none"><strong>12-Feb-08</strong></font>
																	onwards - do visit the website accordingly.</p>

...
namespace NASSCOM_NAC.Web
{
	...
	/// </summary>
	public partial class JobFairCard : System.Web.UI.Page
	{
		...
		private void GetJobFairCard()
		{
			...
			try
			{
				...
				dsJobAdmitCard = oBLJobAdmitCard.GenerateJobAdmitCard(strPinNo);
				...
				if (dsJobAdmitCard.Tables[0].Rows.Count > 0)
				{
					...
					lblState.Text = dsJobAdmitCard.Tables[0].Rows[0]["State"].ToString();
						...
						lblAnalytical.Text = dsJobAdmitCard.Tables[0].Rows[0]["Analytical"].ToString();
						lblListening.Text = dsJobAdmitCard.Tables[0].Rows[0]["Listening"].ToString();
						lblWriting.Text = dsJobAdmitCard.Tables[0].Rows[0]["Writing"].ToString();
						lblSpeaking.Text = dsJobAdmitCard.Tables[0].Rows[0]["Speaking"].ToString();
					...
					if(Convert.ToString(dsJobAdmitCard.Tables[0].Rows[0]["State"])=="Gujarat")
					{
						TblInterview.Visible=false;
						TblInterview2.Visible=true;	
						grpTier.Visible=false; 
		...
		protected void btnSave_Click(object sender, System.EventArgs e)
		{
			if(Session["UserID"] != null)
			{
				...
				objGenerateJobFairCardPDF.GenerateJobFairCardPDF(strPinNo);			 

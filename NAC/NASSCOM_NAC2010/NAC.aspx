<%@ Page language="c#" Codebehind="NAC.aspx.cs" AutoEventWireup="false" Inherits="NASSCOM_NAC.NAC" %>
								...
								<table cellSpacing="0" cellPadding="0" width="240" border="0">
									<tr>
										<td class="loginBoxBack" style="BACKGROUND-IMAGE: url(Web/Images/RegisterForNAC.jpg)">
											<div class="loginBoxDivHome">
												<div><asp:dropdownlist id="ddlState" runat="server"></asp:dropdownlist>&nbsp;<asp:imagebutton id="btnGo" ImageUrl="Web/Images/gobtn.gif" Runat="server"></asp:imagebutton></div>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr style="MARGIN-TOP: 100px">
										<td style="MARGIN-TOP: 100px">
											<p align="center" style="MARGIN-TOP: 5px"><A href="NAC.aspx"><IMG onclick="new_window('Web/SendFeedbackMail.aspx?type=nac');" src="Web/Images/WriteToUsLanding.jpg"
														border="0"></A></p>
										</td>
									</tr>
								</table>
